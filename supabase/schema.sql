...
drop policy if exists "completions_read_all"   on public.completions;
...
-- Public profiles page needs to read any user's completions for badge/progress display
create policy "completions_read_all"   on public.completions for select using (true);
